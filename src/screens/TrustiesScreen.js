...
const TrustiesScreen = ({navigation}) => {
    ...
    const getdata = async () => {
        setloading(true)
        await axios.get(ApiUtils.Governance).then(data => {
        ...
        <View>
            <View style={{
                    ...
                    <AntDesign
                        ...
                        }]} numberOfLines={1}>Governance</Text>
             ...
             renderItem={({ item, index }) => {
                 return (
                     <Pressable
                         onPress={() => {
                             navigation.navigate("TrustiesDetailScreen", { dr: item })
                         }}
                         style={{
                         ...
                         <Image style={{
                             ...
                             source={{
                                 uri: `${ImageService.Governance}${item.Image}`
                             }} />
                         <View style={{
